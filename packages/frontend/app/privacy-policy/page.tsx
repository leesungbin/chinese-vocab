...
export const metadata: Metadata = {
  ...
  description: 'Privacy policy for the Chinese Vocabulary Learning App detailing how we collect, use, and protect your data.',
}
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                <li>Google account information (name, email address, profile picture) when you sign in</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <li>Create and manage personalized Google Sheets for vocabulary tracking</li>
                ...
                <li>Ensure application security and prevent unauthorized access</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-3">4.1 Google OAuth 2.0</h3>
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                <li>We use Google OAuth 2.0 for secure user authentication</li>
                <li>We request minimal necessary scopes: profile, email, drive.file, and spreadsheets</li>
                <li>Access tokens are used only for authorized API operations</li>
              </ul>

              <h3 className="text-xl font-medium text-gray-900 mb-3">4.2 Google Drive and Sheets API</h3>
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                <li>We create Google Sheets in your personal Google Drive for vocabulary tracking</li>
                <li>We only access files created by our application (using drive.file scope)</li>
                <li>You maintain full ownership and control of your Google Sheets</li>
                <li>You can revoke access at any time through your Google Account settings</li>
              </ul>

              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                <p className="text-blue-800 text-sm">
                  <strong>Important:</strong> Our application's use of information received from Google APIs adheres to the 
                  <a href="https://developers.google.com/terms/api-services-user-data-policy" className="underline text-blue-600 hover:text-blue-800" target="_blank" rel="noopener noreferrer">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                <li>User data is stored securely using AWS DynamoDB and AWS Lambda</li>
                <li>Authentication tokens are stored locally in your browser</li>
                <li>Vocabulary data is stored both in our database and your personal Google Sheets</li>
              </ul>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <li>OAuth tokens are stored securely and transmitted over encrypted connections</li>
                <li>We implement industry-standard security practices for data protection</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <li>In connection with Google API services as described in this policy</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <li><strong>Revoke Access:</strong> Revoke Google API access through your Google Account settings</li>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <p className="text-gray-700">
                  <strong>Email:</strong> lee@sungbin.dev<br />
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">14. Legal Compliance</h2>
              <p className="text-gray-700 mb-4">
            ...
            <div className="border-t border-gray-200 pt-6 mt-8">
              <p className="text-sm text-gray-500">
                ...
                By using our Chinese Vocabulary Learning App, you acknowledge that you have read and understood this Privacy Policy.
              </p>
            </div>
          </div>
        </div>
